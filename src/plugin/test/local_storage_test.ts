...
describe('localStorageIO', () => {
  ...
  it('Save-load round trip succeeds', async () => {
    ...
    const handler2 = localStorageIO('FooModel');
  ...
  it('Save-load round trip succeeds: v0 format', async () => {
    const handler1 = localStorageIO('FooModel');
